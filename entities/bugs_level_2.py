...
class Bug_Level_2:
    def __init__(self, x, y, can_shoot=True):
        # Randomly pick between 3 ships for level 2 variety
        ...
        self.image = pygame.transform.rotate(self.image, 90)  # face downward
        ...
        self.shoot_cooldown = random.randint(800, 2000)
